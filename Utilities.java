...
public class Utilities {
	...
	public static char runFSM(State[] FSM, int stateID, String input, String separator) {

		// input is a sequence of symbols from the input alphabet separated by string in
		// separator.
		...
		// Utilities.debugFSMExecution("\nFSM execution begins. Input: " + input + "
		// Initial state: " + stateID);
		if (FSM[stateID] == null) {
			// Utilities.printException("wAlgorithm", "runFSM", "Invalid start state.
			// Execution aborted.");
			return 'n';
		}
		while (inputTokens.hasMoreTokens()) {
			...
			try {
				...
				// Utilities.debugFSMExecution(" Input: "+token+" Next state: "+nextState+"
		...
		// Utilities.debugFSMExecution("\nFSM execution completed. Final state:
		// "+currentState);
		return outputPattern.charAt(outputPattern.length() - 1);
